...
namespace DriveDrop.Bl.Controllers
{
    ...
    public class ReviewController : Controller
    {
        ...
        public ReviewController(IHostingEnvironment env, DriveDropContext context, IMapper mapper)
        {
            _context = context;
            _env = env;
    ...
    public async Task<IActionResult> QuestionList()
    {
        ...
        public async Task<IActionResult> GetReviewByShippingId(int id, [FromQuery]int pageIndex = 0, [FromQuery]int pageSize = 10)
        {
            ...
            var query = _mapper.Map<List<Review>, List<ReviewModel>>(itemsOnPage);


            var model = new ViewModels.PaginatedItemsViewModel<ReviewModel>(
        ...
        public async Task<IActionResult> Items(int? senderId, int? driverId, int? published, int? reviewAppliedTo, int? shippingId, [FromQuery]int pageIndex = 0, [FromQuery]int pageSize = 10)
        {
            ...
            var model = new ViewModels.PaginatedItemsViewModel<Review>(
