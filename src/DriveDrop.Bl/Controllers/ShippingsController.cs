   ...
   //[Authorize]
    ...
    public class ShippingsController : Controller
    {
        ...
        public ShippingsController(IHostingEnvironment env, DriveDropContext context, IIdentityService identityService, 
            ...
            IDistanceService distanceService, IMapper mapper, IShippingService  shippingService)
        {
            _mapper = mapper;
            _settings = settings;
            _context = context;
            ...
            try
            {
              ...
              .Where(x => x.Id > 0);
               ...
               .ToListAsync();
                ...
                {
                     ShippingList = _mapper.Map<List<Shipment>, List<ShipmentModel>>(model.Data.ToList()),
        ...
        // GET Shippings/GetNotAssignedShipping
        [HttpGet]
        [Route("[action]")]
