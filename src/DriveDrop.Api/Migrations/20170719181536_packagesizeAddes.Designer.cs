...
namespace DriveDrop.Api.Migrations
{
    ...
    [Migration("20170719181536_packagesizeAddes")]
    partial class packagesizeAddes
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("ApplicationCore.Entities.ClientAgregate.PackageSize", b =>
                {
                    b.Property<int>("Id")
                        .HasDefaultValue(1);
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Helpers.RateTranportType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("TranportTypeId");

                    b.HasKey("Id");

                    b.HasIndex("RateId");

                    b.ToTable("RateTranportTypes");
                });
            ...
            modelBuilder.Entity("ApplicationCore.Entities.ClientAgregate.ShipmentAgregate.Shipment", b =>
                {
                    ...
                    b.HasOne("ApplicationCore.Entities.ClientAgregate.PackageSize", "PackageSize")
                        .WithMany()
