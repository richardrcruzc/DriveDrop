...
namespace DriveDrop.Api.Services
{
    public interface IRateService
    {
        ...
        Task<CalculatedCharge> CalculateAmount(int zipFrom, int zipTo, decimal weight, int qty, int priority, int transportTypeId, string promoCode, int packageSizeId = 0);
