...
using DriveDrop.Api.Application.Models;
...
namespace Microsoft.eShopOnContainers.Services.DriveDrop.Api.Application.Commands
{
        ...
        : IRequest<bool>
    {
        ...
        public CreateShippingCommand(List<BasketItem> basketItems, string userId, string city, string street, string state, string country, string zipcode,
