...
[assembly: Dependency(typeof(GoNavService))]
namespace GoDriveDrop.Core.Services
{
	public class GoNavService : IGoNavService
	{
			...
			where ViewModel : BaseViewModel
		{
			...
			//if (navigation.NavigationStack.Last().BindingContext is GoBaseViewModel<WalkParam>)
			//	await ((GoBaseViewModel<WalkParam>)(navigation.NavigationStack.Last().BindingContext)).Init(parameter);
		}
