...
namespace DriveDrop.Web.Controllers
{
   // [Route("api/v1/[controller]")]
    public class DriverController : Controller
    {
        ...
        public DriverController(IHostingEnvironment env, ICustomerService customerService, IImageService imageService,
            IAppLogger<CustomerController> logger, DriveDropContext context, IOptionsSnapshot<AppSettings> settings)
        {
            _env = env;
            ...
            _remoteServiceBaseUrl = $"{_settings.Value.BaseUrl}/api/v1/Drivers/";
        }
