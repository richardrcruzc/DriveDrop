...
namespace DriveDrop.Core.Controls
{
    public class MaskedEntry : Entry
    {
        ...
        public static readonly BindableProperty LastTextProperty =
            BindableProperty.Create("LastText", typeof(string), typeof(MaskedEntry), "");

        /// <summary>
        /// The font property
        /// </summary>
        public static readonly BindableProperty MaxLengthProperty =
            BindableProperty.Create("MaxLength", typeof(Int32), typeof(MaskedEntry), -1);
        ...
        public static readonly BindableProperty FontProperty =
            BindableProperty.Create("Font", typeof(Font), typeof(MaskedEntry), new Font());

        /// <summary>
        /// The XAlign property
        /// </summary>
        public static readonly BindableProperty XAlignProperty =
            BindableProperty.Create("XAlign", typeof(TextAlignment), typeof(MaskedEntry),
                TextAlignment.Start);
        ...
        public static readonly BindableProperty HasBorderProperty =
            BindableProperty.Create("HasBorder", typeof(bool), typeof(MaskedEntry), true);

        /// <summary>
        /// The PlaceholderTextColor property
        /// </summary>
        public static readonly BindableProperty PlaceholderTextColorProperty =
            BindableProperty.Create("PlaceholderTextColor", typeof(Color), typeof(MaskedEntry), Color.Default);

        public static readonly BindableProperty CharacterMatchProperty =
            BindableProperty.Create("CharacterMatch", typeof(string), typeof(MaskedEntry), "");

        public static readonly BindableProperty TextLengthProperty =
            BindableProperty.Create("TextLength", typeof(Int32), typeof(MaskedEntry), -1);

        public static readonly BindableProperty SelectionEndProperty =
            BindableProperty.Create("SelectionEnd", typeof(Int32), typeof(MaskedEntry), -1);

        public static readonly BindableProperty SetSelectionProperty =
            BindableProperty.Create("SetSelection", typeof(SelectionPoint), typeof(MaskedEntry), new SelectionPoint(-1));

        public static readonly BindableProperty SelectionStartProperty =
            BindableProperty.Create("SelectionStart", typeof(Int32), typeof(MaskedEntry), -1);

        public static readonly BindableProperty MaskProperty =
            BindableProperty.Create("Mask", typeof(List<MaskRules>), typeof(MaskedEntry), null);

        //		public static readonly BindableProperty MaxLengthProperty =
        //			BindableProperty.Create<MaskedEntry, Int32>(
        //				p => p.MaxLength, -1);
        public static readonly BindableProperty LockedProperty =
            BindableProperty.Create("Locked", typeof(bool), typeof(MaskedEntry), false);

        public static readonly BindableProperty DeleteProperty =
            BindableProperty.Create("Delete", typeof(bool), typeof(MaskedEntry), false);

        public static readonly BindableProperty FormatCharactersProperty =
            BindableProperty.Create("FormatCharacters", typeof(string), typeof(MaskedEntry), "");

        public static readonly BindableProperty RawTextProperty =
            BindableProperty.Create("RawText", typeof(string), typeof(MaskedEntry), "");
        ...
        public static readonly BindableProperty TextUpdateProperty =
            BindableProperty.Create("TextUpdate", typeof(string), typeof(MaskedEntry), "", propertyChanged: TextUpChanged);

        static void TextUpChanged(BindableObject bindable, object oldValue, object newValue)
        {
            MaskedEntry ctrl = (MaskedEntry)bindable;
